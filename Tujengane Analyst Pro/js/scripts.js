const modules = [
    {
    title: "Data Analyst Basics and File Management",
        slides: [
            { title: "Data Analyst Basics and File Management", content: `<div class="ai-slide-block"><ol class='highlight-list'>
                <li><strong>Objective:</strong> Learn to use computers for data analysis tasks.</li>
                <li><strong>Today:</strong> Understand analyst tools and organize files.</li>
                <li><strong>Why It Matters:</strong> Save time analyzing, reporting, and more!</li>
                <li>What do you want to do as a data analyst? (e.g., analyze sales data)</li>
                <hr><div class="activity-block"><strong>Activity:</strong> Share one thing you want to do as a data analyst.</div>
            </ol></div>` },
...
const welcomeSlide = {
    ...
    <div class="welcome-block" style="padding:1.2rem 0.5rem 1rem 0.5rem; text-align:center; max-width: 98vw; min-height: 0;">
        <div style="font-size:1rem; color:#333; margin-bottom:1rem;">
            Welcome to our 13-week data analyst course by <strong>EXES BI</strong>!<br>
        ...
        <div style="font-size:0.93rem; color:#666; margin-bottom:0.7rem;">
            ...
            <span style="color:#256d4f;">Ready to grow your data analyst skills? Start now!</span>
        </div>
        <div style="font-size:0.9rem; color:#888; margin-top:0.5rem;">
            <em>EXES BI – Empowering your future with practical data analyst skills.</em>
        </div>
    </div>
    `
};
