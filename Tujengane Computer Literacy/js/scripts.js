const modules = [
    ...
    },
    {
        ...
        slides: [
            { title: "Artificial Intelligence – Your New Digital Assistant", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Learn how AI can save time, improve decisions, and open new opportunities.</li></ol><div class="ai-action-box">💡 <strong>Class Discussion:</strong> Who has heard of AI before? What do you think it does? <br><em>Share your ideas with the group!</em></div></div>` },
