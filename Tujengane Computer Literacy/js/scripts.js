const modules = [
    ...
    },
    {
        ...
        slides: [
            ...
            { title: "AI You Already Use Daily", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>M-Pesa: fraud alerts, transaction summaries.</li><li>YouTube/TikTok: video suggestions.</li><li>Google Translate: instant language help.</li><li>Facebook: friend suggestions, auto-tagging photos.</li></ol><div class="ai-action-box">📱 <strong>Quick Poll:</strong> Have you used any of these today? <em>Think about which ones you use most often.</em></div></div>` },
            { title: "AI for Small Business", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Track sales trends automatically.</li><li>Predict which products will sell more.</li><li>Manage stock levels.</li><li>Send targeted messages to customers.</li></ol><div class="ai-action-box">🏪 <strong>Local Example:</strong> Imagine your shop knows which items will run out next week — that’s AI helping.</div></div>` },
            { title: "AI for Personal Productivity", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Voice-to-text: speak instead of typing.</li><li>Smart typing: auto-complete messages.</li><li>Calendar suggestions: best time to meet.</li><li>Photo sorting: group by faces or places.</li></ol><div class="ai-action-box">🎤 <strong>Try It:</strong> Use voice-to-text on your phone. Do you ever struggle with typing long messages?</div></div>` },
            { title: "AI for Learning", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Chatbots that explain topics in simple words.</li><li>AI quizzes that adjust to your level.</li><li>Apps that correct your pronunciation.</li><li>Study summaries from long notes.</li></ol><div class="ai-action-box">🧑‍💻 <strong>Demo:</strong> Ask ChatGPT or Bing Copilot a basic question. See how it answers!</div></div>` },
            { title: "AI for Data Analysis", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Automatically creates charts from data.</li><li>Spots patterns you might miss.</li><li>Writes summaries and recommendations.</li><li>Saves hours of manual work.</li></ol><div class="ai-action-box">📊 <strong>Showcase:</strong> See a sample Excel sheet, then an AI-generated chart and insight.</div></div>` },
            { title: "Free AI Tools You Can Try Today", content: `<div class="ai-slide-block"><ol class='highlight-list'><li><strong>ChatGPT / Bing Copilot:</strong> Ask questions, get answers.</li><li><strong>Canva Magic Design:</strong> Create posters and graphics.</li><li><strong>Google Lens:</strong> Identify objects, translate signs.</li><li><strong>Grammarly:</strong> Improve your writing.</li></ol><div class="ai-action-box">🌐 <strong>Explore:</strong> Try one of these tools after class and share your experience next time!</div></div>` },
            { title: "How to Start Using AI", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Pick one task you do often.</li><li>Search for an AI tool that helps with it.</li><li>Try it with small, safe data.</li><li>Keep what works, drop what doesn’t.</li></ol><div class="ai-action-box">📝 <strong>Example:</strong> Typing long messages? Use voice-to-text. Making posters? Try Canva.</div></div>` },
            { title: "Skills to Work Well with AI", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Ask clear questions (called prompts).</li><li>Check AI’s answers — don’t trust blindly.</li><li>Combine AI help with your own thinking.</li></ol><div class="ai-action-box">💬 <strong>Prompt Practice:</strong> <span class='good-prompt'>Good:</span> “Give me 3 tips to grow a small shop in Kenya.” <span class='bad-prompt'>Bad:</span> “Tell me about business.”</div></div>` },
            { title: "Risks & How to Stay Safe", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Don’t share private info (ID, passwords).</li><li>Double-check facts — AI can be wrong.</li><li>Don’t copy blindly — learn and improve.</li><li>Keep learning — AI changes fast.</li></ol><div class="ai-action-box">⚠️ <strong>Remember:</strong> AI is a helper, not a master. You’re still in control.</div></div>` },
            { title: "Call to Action", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Try one AI tool this week.</li><li>Use it for one task (typing, learning, designing).</li><li>Share your experience in the next class.</li></ol><div class="ai-action-box">✅ <strong>Homework:</strong> Pick one tool, use it, and tell us what happened!</div></div>` },
            { title: "Bonus: AI in Kenya", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>Local banks use AI for fraud detection.</li><li>Kenyan startups use AI for agriculture (predicting weather, crop diseases).</li><li>AI chatbots help with customer service in local businesses.</li></ol><div class="ai-action-box">🌍 <strong>Discussion:</strong> Where else could AI help in our country?</div></div>` },
            { title: "Bonus: The Future of AI", content: `<div class="ai-slide-block"><ol class='highlight-list'><li>AI is getting better at understanding language and images.</li><li>More jobs will use AI tools in the future.</li><li>Learning AI basics now gives you an advantage.</li></ol><div class="ai-action-box">🚀 <strong>Encouragement:</strong> You don’t need to be a programmer to use AI. Curiosity and practice are enough!</div></div>` }
        ]
    },
    {
...
function handlePrev() {
    ...
    if (currentModule !== null && currentSlide > 0) {
        ...
        // Show disabled feedback when at beginning
        showDisabledFeedback('prev');
    }
}
...
// Password protection and authentication functions
function initializePasswordProtection() {
    var correctPassword = 'literacy2025'; // Change this password as needed
    var tries = 0;
    var sessionKey = 'tujengane_literacy_authenticated';

    // If the user already entered the correct password this browser session, show the page and skip the prompt
    try {
        ...
        // sessionStorage may be unavailable in some contexts; fall back to prompting
    }

    function showWhatsAppOverlay(){
        var waUrl = 'https://wa.me/254791360805?text=' + encodeURIComponent('Hey, I am requesting for the password to access Tujengane Computer Literacy.');
    ...
    function askPassword() {
        // Visual wrapper/backdrop/box pattern (matches the WhatsApp overlay visual)
        var wrapper = document.createElement('div');
...
function setupFloatingHomeButton() {
    // Show floating Home button only on small screens
...
const navigationDelay = 300; // Prevent too rapid navigation
...
function showDisabledFeedback(direction) {
    const feedbackId = direction === 'prev' ? 'nav-feedback-left' : 'nav-feedback-right';
    const feedbackEl = document.getElementById(feedbackId);
    if (feedbackEl) {
        const originalBg = feedbackEl.style.background;
        feedbackEl.style.background = 'rgba(156, 163, 175, 0.9)';
        feedbackEl.classList.add('show');
        
        setTimeout(() => {
            feedbackEl.classList.remove('show');
            feedbackEl.style.background = originalBg;
        }, 600);
    }
}
...
function handleTouchEnd(e) {
    ...
    // Require more horizontal movement than vertical to avoid interfering with scrolling
...
// Handle touch move to prevent scrolling during horizontal swipes
function handleTouchMove(e) {
    ...
    // If it's clearly a horizontal swipe, prevent vertical scrolling
...
function initializeKeyboardNavigation() {
    document.addEventListener('keydown', (e) => {
        ...
        // Left arrow key or Page Up - previous slide
        if (e.key === 'ArrowLeft' || e.key === 'PageUp') {
            e.preventDefault();
            showNavigationFeedback('prev');
            handlePrev();
        }
        // Right arrow key, Page Down, or Space - next slide
        ...
        // End key - go to last slide of current module
        else if (e.key === 'End') {
            e.preventDefault();
            if (currentModule !== null) {
                const lastSlide = modules[currentModule].slides.length - 1;
